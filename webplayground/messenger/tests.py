...
# con el assertEqual verificas si se añadieron los users correctamente
    ...
    def test_add_messages_to_thread(self):
        ...
        message2 = Message.objects.create(user=self.user2, content= 'Hola que tal ? , a los tiempos')
    ...
    def test_add_messages_from_users_in_not_thread(self):
        self.thread.users.add(self.user1, self.user2)
        message1 = Message.objects.create(user=self.user1, content='Hola Buenas')
        message2 = Message.objects.create(user=self.user2, content='Hola que tal ? , a los tiempos')
